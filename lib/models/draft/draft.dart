...
extension ReadingLengthX on ReadingLength {
  String get parsed => switch (this) {
    ReadingLength.oneToThree => '1-3 min',
    ReadingLength.fourToFive => '4-5 min',
    ReadingLength.sizeToEight => '6-8 min',
    ReadingLength.nineToTwelve => '9-12 min',
    ReadingLength.thirteenPlus => '13+ min',
  };
}
